...
export class Toolbar {
    ...
    private createToolbars() {
        ...
        // 4. Center Group (Project Name & Brush Settings)
        ...
        Object.assign(this.projectNameDisplay.style, {
            ...
            pointerEvents: 'none' // Don't block clicks to things behind if necessary
        });
        ...
        btnBrushSettings.title = "Pinsel-Einstellungen des 1. Pinsels der Davinci Maschine";
        ...
        btnBrushSettings.onclick = () => {
            console.log("Toolbar: Brush settings button clicked");
            this.eventBus.emit('open-brush-properties', null);
        };
        centerGroup.appendChild(btnBrushSettings);
        ...
        this.addButton('brush_create', '🖌️', '3D Pinsel erstellen', this.leftToolbar);
    ...
    private addButton(id: string, symbol: string, title: string, container: HTMLElement) {
        const btn = document.createElement('button');
